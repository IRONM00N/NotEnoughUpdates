...
public class ProfileViewer {
    ...
    private static NEUManager manager;
    ...
    static {
        ...
        skillToSkillDisplayMap.put("slayer_enderman", Utils.createItemStack(Items.ender_pearl, EnumChatFormatting.GOLD+"Voidgloom Slayer"));
    }
